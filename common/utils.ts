...
const USER_AGENT = `modelcontextprotocol/verbiliomcp/v${VERSION} ${getUserAgent()}`;
...
// export async function githubRequest(url: string, options: RequestOptions = {}): Promise<unknown> {
//   const headers: Record<string, string> = {
...
// export async function checkBranchExists(owner: string, repo: string, branch: string): Promise<boolean> {
//   try {
